        ...
        child: SingleChildScrollView(
          child: Column(
            children: const [
              ...
              Text(
                  '''I had the opportunity to work with Jazsley when I joined AnXing Tech as an intern. We were grouped together to work on a new eCommerce application. 

Working with Jazsley has been a great experience. He is very talented, easy to get along with and a real team player. He has also been a great coach and supported me when I started my journey as a Junior Mobile Developer. 

What sets Jazz apart from other developers is his can-do attitude. During my time working with him, he has always been the one willingly taking up the most challenging tasks at hand. Jazsley is also approaching new tasks with a very positive mindset, you’ll never hear him say that something is impossible or can’t be done. He has also proven multiple times that he can deliver. It is very rare to come across someone who is acting so calmly and controlled under stressful project situations. 
