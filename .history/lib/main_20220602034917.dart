...
class _MainPageState extends State<MainPage> {
  ...
  void initState() {
    ...
    Provider.of<NovadeProvider>(context, listen: false).getNovadeInfo();
  ...
  Widget build(BuildContext context) {
    return Consumer<TestimonialProvider>(
      builder: (context, testimonialProvider, _) => testimonialProvider
                              ...
                              child: Column(
                                children: [
                                  ...
                                  ElevatedButton(
                                      ...
                                      child:
                                          const Text('Click Here To Know More'))
                                ],
                              ),
                            ),
                          ))
